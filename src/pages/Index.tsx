...
const Index = () => {
  return <div className="min-h-screen bg-background">
      ...
      <div className="relative w-full h-80 md:h-96 mb-12 overflow-hidden">
        ...
        {/* Circular Badge */}
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 w-48 h-48 md:w-64 md:h-64 rounded-full flex items-start justify-center pt-6 md:pt-8 shadow-elevated overflow-hidden z-20">
          <div className="absolute inset-0 bg-center bg-cover" style={{backgroundImage: `url(${americanFlag})`}}></div>
